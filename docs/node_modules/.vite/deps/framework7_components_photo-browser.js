import {
  ConstructorMethods,
  jsx_default
} from "./chunk-6O6J6K3D.js";
import {
  class_default
} from "./chunk-JAWA4ZX6.js";
import {
  deleteProps,
  dom7_default,
  extend,
...
var PhotoBrowser = class extends class_default {
  ...
  onSlideChange(swiper) {
    ...
    const $activeSlideEl = pb.params.virtualSlides ? dom7_default(swiper.wrapperEl).find(`.swiper-slide[data-swiper-slide-index="${swiper.activeIndex}"]`) : dom7_default(swiper.slides).eq(swiper.activeIndex);
    const $previousSlideEl = pb.params.virtualSlides ? dom7_default(swiper.wrapperEl).find(`.swiper-slide[data-swiper-slide-index="${swiper.previousIndex}"]`) : dom7_default(swiper.slides).eq(swiper.previousIndex);
  ...
  onTouchMove(e) {
    ...
    if (!swipeToClose.started) {
      ...
      if (pb.params.virtualSlides) {
        swipeToClose.activeSlide = dom7_default(pb.swiper.wrapperEl).children(".swiper-slide-active");
      } else {
        swipeToClose.activeSlide = dom7_default(pb.swiper.slides).eq(pb.swiper.activeIndex);
      }
  ...
  renderNavbar() {
    ...
    })), isPopup && (pb.params.popupCloseLinkText || pb.params.popupCloseLinkIcon) && jsx_default("div", {
      class: "right"
    }, jsx_default("a", {
      class: "link popup-close",
      "data-popup": ".photo-browser-popup"
    }, pb.params.popupCloseLinkIcon && pb.app.theme === "ios" && jsx_default("i", null, jsx_default("svg", {
    ...
    }))), pb.params.popupCloseLinkIcon && pb.app.theme === "md" && jsx_default("i", null, jsx_default("svg", {
      xmlns: "http://www.w3.org/2000/svg",
      height: "24px",
      viewBox: "0 0 24 24",
      width: "24px",
    ...
    }))), pb.params.popupCloseLinkText && jsx_default("span", null, pb.params.popupCloseLinkText)))));
  }
  renderToolbar() {
    const pb = this;
  ...
  renderThumb(thumb, index) {
    ...
    if (pb.params.renderThumb)
      return pb.params.renderThumb.call(pb, thumb, index);
    return jsx_default("div", {
  ...
  render() {
    ...
    }, pb.params.navbar && pb.renderNavbar(), pb.params.toolbar && pb.renderToolbar(), pb.params.thumbs && pb.params.thumbs.length && pb.renderThumbs(), jsx_default("div", {
      ...
      const thumbsSwiperParams = {
        ...
        on: {
          ...
          click(s) {
            if (!s.clickedSlide)
              return;
            const index = parseInt(dom7_default(s.clickedSlide).attr("data-swiper-slide-index"), 10);
            s.slideTo(index, 0);
          }
        }
      };
...
export {
  photo_browser_default as default
};
//# sourceMappingURL=framework7_components_photo-browser.js.map

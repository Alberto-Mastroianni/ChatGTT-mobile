import {
  getDevice
} from "./chunk-BNWOMFHD.js";
import {
  getSupport
} from "./chunk-GYROXX2G.js";
import {
  ConstructorMethods,
  jsx_default
...
var Framework7 = class _Framework7 extends class_default {
  ...
  disableAutoDarkMode() {
    ...
    const app = this;
    if (app.mq.dark)
      app.mq.dark.removeEventListener("change", app.colorSchemeListener);
    if (app.mq.light)
      app.mq.light.removeEventListener("change", app.colorSchemeListener);
  }
  setDarkMode(mode) {
    const app = this;
    if (mode === "auto") {
...
app_class_default.use([device_default, support_default, utils_default, resize_default, touch_default, clicks_default, router_default, history_default2, service_worker_default, store_default, statusbar_default, view_default, navbar_default, toolbar_default, subnavbar_default, touch_ripple_default, modal_default]);
